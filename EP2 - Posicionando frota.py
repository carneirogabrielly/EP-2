...
<<<<<<< HEAD
=======
    #criei um laço com while para que quando a posição for válida o contador atualize, e do contrário pergunta de novo
    
>>>>>>> c68c8679d7fc7206e4de8611bb9abd778e39adcc
    i = 0
